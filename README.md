...
Please [click here](https://github.com/Yvand/LDAPCP/wiki/How-to-install-LDAPCP) to install LDAPCP and [visit the wiki](https://github.com/Yvand/LDAPCP/wiki) to find documentation.
