...
namespace ldapcp.ControlTemplates
{
    ...
    {
        /// <summary>
        /// This member must be set in the markup code, with the name of the claims provider
        /// </summary>
        public string ClaimsProviderName;

        /// <summary>
        /// This member must be set in the markup code, with the name of the persisted object that holds the configuration
        /// </summary>
        public string PersistedObjectName;

        private Guid _PersistedObjectID;
        /// <summary>
        /// This property must be set in the markup code, with the GUID of the persisted object that holds the configuration
        /// </summary>
